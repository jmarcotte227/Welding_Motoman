...
class FLIR_RR_TRACKING(object):
    ...
    def ir_cb(self,pipe_ep):
        ...
        while pipe_ep.Available > 0:
            ...
            if rr_img.image_invof.encoding == self.ir_image_consts["ImageEncoding"]["mono8"]:
                mat = rr_img.data.reshape(
                    [rr_img.image_info.height, rr_img.image_info.width],
                    order='C'
                )
            elif rr_img.image_invof.encoding == self.ir_image_consts["ImageEncoding"]["mono16"]:
            ...
            centroid, bbox = flame_detection_aluminum(ir_image)
