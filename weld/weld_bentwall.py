...
def calc_individual_speed_var(vd_profile,lam1,lam2,lam_relative,breakpoints):
	...
	for i in range(1,len(breakpoints)):
		...
		dt.append((lam_relative[breakpoints[i]]-lam_relative[breakpoints[i-1]])/vd_profile[i-1])
