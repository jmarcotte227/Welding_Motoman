...
def ir_process_cb(sub, value, ts):
    ...
    filter_obj.log_reading(ir_process_packet.flame_position)
...
def main():
    ...
    # )
    recorded_dir = "../../../recorded_data/ER4043_bent_tube_large_hot_streaming_2025_03_11_13_56_45/"
