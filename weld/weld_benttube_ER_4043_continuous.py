...
for layer in range(num_layer_start,num_layer_end,nominal_slice_increment):
	...
	for x in range(0,num_sections,layer_width_num):
		...
		global_ts,robot_ts,joint_recording,job_line,_=ws.weld_segment_dual(primitives,robot,positioner,q1_all,q2_all,v1_all,v2_all,cond_all=[int(feedrate_cmd/10)+job_offset],arc=False, wait=0.)
