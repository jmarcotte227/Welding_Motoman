...
for layer in range(num_layer_start,num_layer_end,nominal_slice_increment):
	...
	for x in range(0,num_sections,layer_width_num):
		...
		for j in range(1,len(breakpoints)):
			...
			q3_all.append(rob2_js[breakpoints[j]])
		...
		timestamp_robot,joint_recording,job_line,_=ws.weld_segment_tri(primitives,robot,positioner,robot2,q1_all,q2_all,q3_all,v1_all,v1_all,cond_all=[int(base_feedrate_cmd/10)+job_offset],arc=True)
...
for layer in range(num_layer_start,num_layer_end,nominal_slice_increment):
	...
	for x in range(0,num_sections,layer_width_num):
		...
		print('V1: ', v1_all)
		print("layer: ", layer)
		timestamp_robot,joint_recording,job_line,_=ws.weld_segment_tri(primitives,robot,positioner,robot2,q1_all,q2_all,q3_all,v1_all,v1_all,cond_all=[int(feedrate_cmd/10)+job_offset],arc=True)
		q_0 = client.getJointAnglesMH(robot.pulse2deg)[0]
		ws.jog_single(robot,[q_0,0,0,0,0,0],4)
