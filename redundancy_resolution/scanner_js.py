# From Eric's branch of Welding_Motoman github repo
...
for i in range(0,slicing_meta['num_baselayers']):
    ...
    for x in range(num_sections):
        ...
        scan_p,scan_R,q_out1,q_out2=spg.gen_scan_path([curve_sliced_relative],[0],all_scan_angle,\
                            solve_js_method=1,q_init_table=positioner_weld_js[0],R_path=mti_Rpath,R1_w=R1_w,R2_w=R2_w,scan_path_dir=scan_data_dir)
