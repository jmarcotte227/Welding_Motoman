...
if __name__ == "__main__":
    ...
    scanned_points_mesh = o3d.io.read_triangle_mesh(data_dir+'5layer_bent_wall_230ipmMatrix_280ipmFill.stl')
    ...
    translation_p = np.array([-7,0,0]) ## CHANGE THIS TO CALIBRATE NEW SAMPLE
