...
for layer in range(num_samples):
    ...
    top_bbox.translate(np.array([0,0,layer_increment*layer+5]))
...
for i in range(len(layer_points)):
    layer_points[i].translate(np.array([0,0,-layer_increment*i-5-3]))
