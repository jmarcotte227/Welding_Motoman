...
ax2.set_ylim(0,2)
fig.savefig('rms_plot_pres.png', dpi=fig.dpi)
plt.show()

# plot legend
ax_leg.legend(*ax1.get_legend_handles_labels(), loc='center', frameon=True, framealpha=0.8)
ax_leg.axis('off')
fig_leg.savefig('legend.png', dpi=fig.dpi)
